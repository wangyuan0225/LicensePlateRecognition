export default {
    ...
    analyze: {
        ...
        modelYolo26: 'YOLO26（适合绝大多数场景，速度适中，识别精准，支持颜色识别）',
        modelYolov8: 'YOLOv8（次时代大模型，速度较快，多用于辅助校验，支持颜色识别）',
        modelResNet: 'ResNet50 混合',
        modelHyperLPR: 'HyperLPR（多用于常见国内车牌识别，速度最快，支持车牌类型识别）',
        modelFusion: 'Nexus（自研最强模型，多维度置信度加权融合上述全部算法返回结果）',
        modelYolov11: 'YOLOv11（配合 LPRNet 框架进行 OCR，不支持类型与颜色识别）',
        dropText: '将文件拖到此处，或',
        clickUpload: '点击上传',
